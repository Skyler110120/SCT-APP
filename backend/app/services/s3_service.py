...
def generate_course_pdf_url(self, course_id: str) -> Dict[str, Any]:
    """
    ...
    """
    object_key = f"coursematerials/pdfs/course-{course_id}.pdf"
    return self._generate_presigned_url(object_key, course_id, "course_pdf")

def generate_instructor_script_url(self) -> Dict[str, Any]:
    """
    Generate a temporary URL for viewing instructor script
    """
    object_key =f"coursematerials/scripts/course-script.pdf"
